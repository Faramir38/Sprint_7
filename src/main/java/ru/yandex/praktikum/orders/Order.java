...
public class Order {
    ...
    public String toString() {
        ...
        sb.append("firstname: ").append(getFirstName()).append("\n")
                ...
                .append("metro: ").append(getMetroStation()).append("\n")
                .append("phone: ").append(getPhone()).append("\n")
                .append("renttime: ").append(getRentTime()).append("\n")
                .append("delivery: ").append(getDeliveryDate()).append("\n")
                .append("comment: ").append(getComment()).append("\n")
                .append("color: ");
                for (String t : color) {sb.append(t).append("\n");}
        return sb.toString();
    }
}
